...
**灵机 · Animac**是[Scheme](https://zh.wikipedia.org/wiki/Scheme)程序语言的一个解释器实现。Animac将Scheme代码编译为中间语言代码，并且在虚拟机上执行。Animac不遵守R<sup>n</sup>RS标准。Animac使用C语言和TypeScript开发，能够在Web浏览器、Node.js等各类环境中运行。
