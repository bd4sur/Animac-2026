...
(define MoB
  (lambda (x)
    ...
    (display "A[10] = ") (display (A x thunk_1 thunk_m1 thunk_m1 thunk_1 thunk_0)) (display " / 期望-67") (newline)
    (display "A[11] = ") (display (A (+ x 1) thunk_1 thunk_m1 thunk_m1 thunk_1 thunk_0)) (display " / 期望-138") (newline)
    (display "A[12] = ") (display (A (+ x 2) thunk_1 thunk_m1 thunk_m1 thunk_1 thunk_0)) (display " / 期望-291") (newline)
    (newline)
))
